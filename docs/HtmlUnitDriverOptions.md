...
the standard **MutableCapabilities** API:
...
standard **MutableCapabilities** API as shown above. All of the capabilities defined by **HtmlUnitDriver** are represented
...
## The BrowserVersionTrait Enumeration
 ...
 The **BrowserVersion** capability of **HtmlUnitDriverOptions** is comprised of many individual traits, and each of these can be read discretely via the standard **MutableCapabiltiies** API. Examples of this are shown above (e.g. - [SYSTEM_TIME_ZONE](#getting-individual-browser-version-traits)). Note that these traits are immutable.
